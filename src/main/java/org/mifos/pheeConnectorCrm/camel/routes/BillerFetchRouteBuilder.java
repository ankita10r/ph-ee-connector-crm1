...
import org.mifos.pheeConnectorCrm.properties.BillerDetails;
import org.mifos.pheeConnectorCrm.properties.BillerDetailsProperties;
...
public class BillerFetchRouteBuilder extends ErrorHandlerRouteBuilder {
    ...
    public void configure() {
        ...
        from("direct:biller-fetch")
                .routeId("biller-fetch")
                .log("Received request for biller fetch")
                .process(exchange -> {
