...
public class BillRTPRespRouteBuilder extends ErrorHandlerRouteBuilder {
    ...
    public void configure() {
        ...
        from("direct:bill-rtp-resp")
                .routeId("bill-rtp-resp")
                .log("Sending response for bill rtp request")
        ...
        from("direct:aync-response")
                .routeId("aync-response")
                .log("Setting response for request for bill inquiry")
                .setHeader(Exchange.HTTP_RESPONSE_CODE, constant(202))
                .setBody(constant("Request Processing"));
    }
